...
def web_scrape_phone_number(phone_number):
    ...
    webbrowser.open(f'https://www.fastpeoplesearch.com/{phone_number}') #might want to delete
    webbrowser.open(f'https://www.searchpeoplefree.com/phone-lookup/{phone_number}')
    webbrowser.open(f'https://www.peoplesearchnow.com/phone/{phone_number}')  #might wanna remove
    webbrowser.open(f'https://www.whitepages.com/phone/1-{phone_number}') #might wanna remove
