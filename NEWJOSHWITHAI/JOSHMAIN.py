...
def recognize_speech():
    ...
    with sr.Microphone() as source:
        ...
        try:
            print("Taking input")
            audio = recognizer.listen(source)
            #audio = recognizer.listen(source, duration=3)
...
def process_user_input(user_input):
    ...
    if user_input.lower() == 'exit':
        ...
        print('Please say the command/word of whatver needs to be done in regards to the model')
        speak('Please say the command/word of whatver needs to be done in regards to the model')
        print('1. feedback')
        print('2. train')
        print('3. save')            
...
#clear the history after using it for training
        ...
        speak("I searched what you asked me too")
