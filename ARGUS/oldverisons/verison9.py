...
def process_user_input(user_input):
    ...
    if user_input.lower() == 'exit':
        ...
        with sr.Microphone() as source:
            ...
            commandaudio = recognizer.listen(source)
        try:
            commandstuff = recognizer.recognize_google(commandaudio, language='en-us')
            print("Me  --> ", commandstuff)
            commandstuff = manualinput
        except:
            print("Me  -->  ERROR")
