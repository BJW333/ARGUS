...
#file tool imports
from utilsfunctions import calculate, gatherinfofromknowledgebase, identifynetworkconnect, start_timer
...
class intentrecognition():
    ...
    def intentunderstand(self, user_input):
        searchwikilist = ['find', 'what is', 'who is', 'search', 'tell me about']
...
def takenotes():
    ...
    speak(f"Just state what you want document in your notes {MASTER}")
