...
def update_audio_volume():
    """reads audio and returns a computed volume for use in animation"""
    global stream
...
csv_file_path = script_dir / 'data/conversation_pairs.csv'
...
(text for text in all_texts), target_vocab_size=2**13)
    ...
    lr_schedule = tf.keras.optimizers.schedules.ExponentialDecay(
        initial_learning_rate, decay_steps=2866, decay_rate=0.89, staircase=True) #orginal decay steps 100000 the decay steps value after using the equation is 634 with current amount of data
