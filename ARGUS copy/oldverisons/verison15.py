...
openai.api_key = 'sk-proj-7lWZ8LjLUXZBgTA3TvG5T3BlbkFJDsfFJExqpU49IOJZ2Wb7'
...
#deletes start and end tokens new mothod delte if not working
    ...
    def save_model(self):
        self.model.save_weights('/Users/blakeweiss/Desktop/NEWJOSHWITHAI/model_weights.weights.h5')
    ...
    def load_model(self):
        if os.path.exists('/Users/blakeweiss/Desktop/NEWJOSHWITHAI/model_weights.weights.h5'):
...
def takenotes():
    filepath = 'Desktop/NEWJOSHWITHAI/NOTES/notes.txt'
    ...
    if not os.path.exists(filepath):
        ...
        print("its true")
        newfilenum = 1
        while os.path.exists(f"Desktop/NEWJOSHWITHAI/NOTES/notes{newfilenum}.txt"):
            newfilenum += 1
        new_filepath = f"Desktop/NEWJOSHWITHAI/NOTES/notes{newfilenum}.txt"     
