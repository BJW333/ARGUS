...
from brain.nlp.chatbot import Chatbot
...
def initialize_chatbot_components():
    ...
    # Initialize the chatbot with default parameters
    chatbot = Chatbot(reward_system=reward_system) #pass reward system to chatbot for confidence calculation
