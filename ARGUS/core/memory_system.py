...
class MemoryManager():
    ...
    def __init__(self, memory_path: str = "memory") -> None:
        ...
        #self.short_term = []  #list of recent conversation turns #now is saved in a json file instead of local array
        #self.embedder = SentenceTransformer(self.EMBEDDING_MODEL)
        # embedder now loaded lazily via _get_embedder()
    ...
    def _embed(self, text: str) -> np.ndarray:
        return self._get_embedder().encode(text)
