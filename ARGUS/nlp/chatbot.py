...
class Chatbot:
    def __init__(self, model_id="argus", max_tokens=400, max_generate_attempts: int = 10, reward_system=None):
    ...
    def _generate_single_candidate(self, prompt, temperature, top_k, top_p):
