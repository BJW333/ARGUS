...
class intentrecognition():
    ...
    def calculate_confidence(self, user_input, intent_keywords):
        ...
        matched_keywords = sum(1 for keyword in intent_keywords if keyword in user_input_lower)
    ...
    def intentunderstand(self, user_input):
        ...
        drink_cocktail = ["I want to make a cocktail", "I want to make a drink"]
...
#orginally was dataset = list(zip(input_texts, target_texts)) but didnt want redudent variables figure out if this can be changed in the future
