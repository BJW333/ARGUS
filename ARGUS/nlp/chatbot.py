...
class Chatbot:
    def __init__(self, model_id="argus-34b", max_tokens=1024, max_generate_attempts: int = 10, reward_system=None):
        self.model_name = model_id
        #self.max_tokens = max_tokens
        
        #TOKEN CONTROL (TWO KNOBS)
        self.candidate_max_tokens = max_tokens   #KNOB 1: short candidates for GA
        self.final_max_tokens = 2048   #KNOB 2: long final answer (expand) set to 4096 if you want big answers 
    ...
    def choose_num_predict(self, prompt: str, num_ctx: int = 8192, max_out: int = 2048, buffer: int = 300):
    ...
    def _generate_single_candidate(self, system_prompt, user_prompt, temperature, top_k, top_p, num_predict):
        ...
        try:
            timeout = max(180, 60 + int(num_predict) / 5) #simple heurstic 
