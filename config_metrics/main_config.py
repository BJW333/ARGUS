...
def ensure_vader_lexicon():
    """
    Ensure the VADER lexicon is downloaded for sentiment analysis.
...
ARGUS_DIR = script_dir.parent  # /Users/{user}/Desktop/ARGUS
WORKSPACE_CONFIG_DIR = script_dir  # config_metrics/
WORKSPACES_CONFIG_FILE = script_dir / "workspaces.json"
WORKSPACE_ROOT = ARGUS_DIR / "data/outputs"  # Inside ARGUS folder
